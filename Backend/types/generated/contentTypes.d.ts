...
export interface ApiArticoloGdprArticoloGdpr
  extends Struct.CollectionTypeSchema {
...
export interface ApiMvcMvc extends Struct.CollectionTypeSchema {
  collectionName: 'mvcs';
  info: {
    displayName: 'MVC';
    pluralName: 'mvcs';
...
export interface ApiPrincipioPbdPrincipioPbd
  extends Struct.CollectionTypeSchema {
...
export interface ApiStretegiaStretegia extends Struct.CollectionTypeSchema {
  collectionName: 'stretegias';
  info: {
    displayName: 'Stretegia';
    pluralName: 'stretegias';
    singularName: 'stretegia';
  };
  options: {
    draftAndPublish: true;
  };
